...
project = u'EnOS Stream Analytics'
...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS Stream Analytics} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{30pt}{\baselineskip}\selectfont \textbf{Stream Analytics}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'EnOS Stream Analytics',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS Stream Analytics',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Stream Analytics',
